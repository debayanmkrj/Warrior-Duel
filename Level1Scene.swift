...
class Level1Scene: GameScene {
    ...
    private func showLevelInfo() {
        ...
        enemyLabel.text = "Defeat the Converted Vampire"
    ...
    private func setupCastleBackground() {
        //  castle background
        castleBackground = SKSpriteNode(imageNamed: "castle")
    ...
    private func introduceConvertedVampire() {
