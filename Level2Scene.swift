...
class Level2Scene: GameScene {
    ...
    private func showLevelInfo() {
        ...
        enemyLabel.text = "Defeat the Vampire Girl"
    ...
    private func setupCastleBackground() {
        ...
        castleBackground = SKSpriteNode(imageNamed: "terrace")
        ...
        print("Terrace background added")
    }
    
    
    private func setupLevel2Elements() {
        ...
        print("Level 2 specific elements added")
    }
    ...
    private func addTorch(at position: CGPoint) {
        ...
        flame.particleTexture = SKTexture(imageNamed: "spark")
    ...
    private func introduceVampireGirl() {
